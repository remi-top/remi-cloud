package ai.remi.sys.domain.tree;
...
public class CompanyTree extends TreeNode<CompanyTree> implements Serializable {
    private static final long serialVersionUID = -88239778889283311L;
    /**
     * ID
     */
