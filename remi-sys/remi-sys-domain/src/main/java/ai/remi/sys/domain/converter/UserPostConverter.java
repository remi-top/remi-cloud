...
import ai.remi.sys.domain.dto.post.UserPostPostDTO;
import ai.remi.sys.domain.dto.put.UserPostPutDTO;
import ai.remi.sys.domain.entity.UserPost;
import ai.remi.sys.domain.query.UserPostQuery;
import ai.remi.sys.domain.vo.UserPostVO;
