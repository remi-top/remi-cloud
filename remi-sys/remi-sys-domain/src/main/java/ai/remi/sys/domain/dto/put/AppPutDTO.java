...
import ai.remi.sys.domain.dto.post.ConfigPostDTO;
...
public class AppPutDTO implements Serializable {
    private static final long serialVersionUID = 477907193450480244L;
