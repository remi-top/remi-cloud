 ...
 */
@Configuration
public class BusinessPlanThreadPoolTask {
	private Logger log = LoggerFactory.getLogger(BusinessPlanThreadPoolTask.class);
	 ...
	 */
	@Bean(name = "businessPlanExcelRead")
	public ThreadPoolTaskExecutor businessPlanThreadPool() {
		...
		//线程名前缀
		executor.setThreadNamePrefix("business-plan-");
		//拒绝策略
