package ai.remi.comm.util.string;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static String splitFirst(final String str, final String delim) {
        if (null == str || org.apache.commons.lang3.StringUtils.isEmpty(delim)) {
            return str;
        }
     ...
     * @return 分割后的返回结果
     */
    public static List<String> splitStr(String str, final String delim) {
        if (null == str) {
    ...
    public static String convertToCamelCase(String name) {
        ...
        // 用下划线将原始字符串分割
        List<String> camels = splitStr(name, "_");
