package ai.remi.comm.util.file;
...
public class FileUtils {
    ...
    public static BigDecimal formatKB(Long fileSize) {
        DecimalFormat df = new DecimalFormat("#.000");
        if (fileSize == 0) {
            return new BigDecimal(0.000);
        }
        return new BigDecimal(fileSize).divide(new BigDecimal(1024)).setScale(3, RoundingMode.HALF_UP);
    }
