...
public class SnowflakeUtils {
    private static final SnowflakeUtils intance = new SnowflakeUtils(1, 1, 1);
    ...
    /**
     * 12位的序列号,代表一毫秒内生成的多个id的最新序号 4096 -1 = 4095 个
     */
    private long sequence;
    /**
     * 设置一个时间初始值    2^41 - 1   差不多可以用69年
     */
    private long twepoch = 1888888888L;
    /**
     * 5位的机器id
     */
    ...
    public static SnowflakeUtils getInstance(long workerId, long datacenterId) {
        return new SnowflakeUtils(workerId, datacenterId, 1);
    }
    ...
    public synchronized String nextShortId() {
        return HashUtils.hashToBase62(this.nextIdStr());
    }
    ...
    public static void main(String[] args) {
        ...
        //SnowflakeIDUtils instance = getInstance(1, 1);
            System.out.println(getInstance().nextId());
            System.out.println(getInstance(2,1).nextId());
        //for (int i = 0; i < 9; i++) {
        //    System.out.println(getInstance().nextId());
        //    //System.out.println(instance.nextShortId());
