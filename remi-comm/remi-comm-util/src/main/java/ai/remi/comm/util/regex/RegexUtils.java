package ai.remi.comm.util.regex;
...
public class RegexUtils {
     ...
     * 正则：整数或者浮点数
     */
    public static final String REGEX_INTEGER_OR_FLOAT = "^-?(\\d|([1-9]\\d+))(\\.\\d+)?$";
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isRegexInteger(CharSequence input) {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean NEGATIVE_FLOAT(CharSequence input) {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isIntegerOrFloat(CharSequence input) {
        return isMatch(REGEX_INTEGER_OR_FLOAT, input);
    }
